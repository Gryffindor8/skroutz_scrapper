        ...
        try:
            ...
            for product_card in product_cards:
                ...
                try:
                    ...
                    continue
                data_ = [product_id, product_name, store_name, str(i + 1), num_cards, price, shipping, delivery,
                         deliver_time]
                df = pd.DataFrame(data=data_,
                                  index=["id", "product_name", "storename", "place", "totalnum", "price",
...
def convert_row(row):
   ...
   <description>%s</description>
        ...
        row.product_id, row.product_name, row.storename, row.place, row.totalnum, row.price, row.shipping)
